...
namespace HSPI_ENVIRACOM_MANAGER
{
	...
	public class clsHvacController
	{
        ...
        private bool            m_bZoneSystemPresent = false;
        ...
        private clsMessageMgr   m_objMessageMgr = new clsMessageMgr();
        ...
        public bool IsZonedSystem
        {
            get
            {
                return m_bZoneSystemPresent;
            }
            set
            {
                m_bZoneSystemPresent = value;
            }
        }
		...
		{
            clsEnviracomApp.TraceEvent(TraceEventType.Verbose, "clsHvacController::Initialize");

            m_objMessageMgr.Initialize(this);
            m_objSACommMgr.ReceiveProcessor = new ProcessingQueue<string>.DoWorkDlgt(m_objMessageMgr.OnDoReceive);
...
//				}
        ...
        public void EnableHomeSeerAccess()
		{
            ...
            SendZoneManagerQueryMessageToUnit();
		}
        ...
        public void SendMessageToUnit(string szMessage)
        {
            // need to check that we have successfully initialized                if (m_objSACommMgr != null)
            {
                clsEnviracomApp.TraceEvent(TraceEventType.Verbose, "clsHvacController::SendMessageToUnit '" + szMessage + "'");
        ...
        public void SendSetTimeMessageToUnit()
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatChangeTimeMessage(0, (int)(dt.DayOfWeek == 0 ? DayOfWeek.Saturday : (dt.DayOfWeek - 1)), dt.Month, dt.Day, dt.Year, dt.Hour, dt.Minute, dt.Second));
        }
        public void SendQueryTempMessageToUnit(int zone)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQueryTempMessage(zone));
        }
        public void SendQuerySetPointsMessageToUnit(int zone)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQuerySetPointsMessage(zone));
        }
        public void SendQuerySetPointLimitsMessageToUnit(int zone)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQuerySetPointLimitsMessage(zone));
        }
        public void SendQueryAllSchedulesMessageToUnit()
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQueryAllSchedulesMessage());
        }
        public void SendQuerySystemSwitchMessageToUnit(int zone)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQuerySystemSwitchMessage(zone));
        }
        public void SendQuerySystemStateMessageToUnit(int zone)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQuerySystemStateMessage(zone));
        }
        public void SendFilterMessageToUnit(int zone)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQueryFilterMessage(zone));
        }
        public void SendTestMessageToUnit()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQuerySystemSwitchMessage(i));
            }
        }
        public void SendZoneManagerQueryMessageToUnit()
        {
            clsEnviracomApp.TraceEvent(TraceEventType.Verbose, "clsSACommMgr::SendZoneManagerQueryMessageToUnit");
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatQueryZoneManagerMessage());
        }
        public void SendHoldMessageToUnit(int iZoneNumber, int iHeatSetPoint, int iHoldStatus, int iCoolSetPoint, int iUnknown_5, int iRecovery, int iPeriod, int iUnknown_7)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatChangeSetPointsMessage(iZoneNumber, iHeatSetPoint, iHoldStatus, iCoolSetPoint, iUnknown_5, iRecovery, iPeriod, iUnknown_7));
        }
        public void SendModeMessageToUnit(int iZoneNumber, int iSwitchSetting)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatChangeModeMessage(iZoneNumber, iSwitchSetting));
        }
        ...
        public void SendFanMessageToUnit(int iZoneNumber, int iFanModeOne, int iFanModeTwo)
        {
            ...
            m_objSACommMgr.TransmitMessage(m_objMessageMgr.FormatChangeFanMessage(iZoneNumber, iFanModeOne, iFanModeTwo));
        }
