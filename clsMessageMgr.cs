...
namespace HSPI_ENVIRACOM_MANAGER
{
    ...
    public class clsMessageMgr
    {
        ...
        public void OnDoReceive(object sender, ProcessingQueueEventArgs<string> args)
        {
            Receive(args.Work);
        }
        #endregion
        ...
        private void Receive(string sMessage)
        {
            Message msg;
            try
            {
        ...
        private void ReceiveZoneManagerMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessZoneManagerMessage(m_objHvacUnit.UnitNumber, iZoneManager);
        ...
        private void ReceiveBlowerFanStatusMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessBlowerFanSpeedMessage(m_objHvacUnit.UnitNumber, iBlowerFanSpeed, iUnknown_1, iUnknown_2, iUnknown_3);
        }
        ...
        private void ReceiveAuxHeatStatusMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessAuxHeatStatusMessage(m_objHvacUnit.UnitNumber, iAuxHeatStatus, iUnknown_1, iUnknown_2, iUnknown_3);
        }
        ...
        private void ReceiveCoolingHeatPumpStatusMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessCoolingHeatPumpStatusMessage(m_objHvacUnit.UnitNumber, iCoolingHeatPumpState, iUnknown_1, iUnknown_2, iUnknown_3);
        }
        ...
        private void ReceiveHeatingHeatPumpStatusMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessHeatingHeatPumpStatusMessage(m_objHvacUnit.UnitNumber, iHeatingHeatPumpState, iUnknown_1, iUnknown_2, iUnknown_3);
        }
        ...
        private void ReceiveCirculateFanMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessCirculateFanMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iUnknown_0, iCirculateFanStatus);
        }
        ...
        private void ReceiveDamperStatusMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessDamperStatusMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iDamperStatus);
        }
        ...
        private void ReceiveAquastatCirculatingPumpStatusMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessAquastatCirculatingPumpStatusMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iDamperStatus);
        }
        ...
        private void ReceiveDehumidifierStateMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessDehumidifierStateMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iDehumidifierMode, iExternalDehumidifierState);
        }
        ...
        private void ReceiveHumidifierStateMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessHumidifierStateMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iUnknown_0, iHumidifierState);
        }
        ...
        private void ReceiveExternalVentilationStateMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessExternalVentilationStateMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iUnknown_0, iExternalVentilationState);
        }
        ...
        private void ReceiveTimeMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessTimeMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iDayOfWeek, iMonth, iDay, iYear, iHours, iMinutes, iSeconds);
        }
        ...
        private void ReceiveErrorMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessErrorMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iUnknown_0, iUnknown_1, iErrorNumber, iUnknown_3, iUnknown_4, iUnknown_5);
        }
        ...
        private void ReceiveSystemStateMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessSystemStateMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iUnknown_0, iUnknown_1, SystemState, StageOneState, StageTwoState, StageThreeState, StageFourState);
        }
        ...
        private void ReceiveEquipmentFaultMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessEquipmentFaultMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iUnknown_0, iUnknown_1, iUnknown_2, iUnknown_3, iUnknown_4);
        }
        ...
        private void ReceiveOutdoorTempMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessOutdoorTempMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iOutdoorTemperature);
        }
        ...
        private void ReceiveSetPointMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessSetPointMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iHeatSetPoint, iHoldStatus, iCoolSetPoint, iUnknown_5, iRecovery, iUnknown_7);
        }
        private void ReceiveSystemSwitchMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessSystemSwitchMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iSystemSwitch, iAutoCurrentMode, iExtraModeByte, iAllowedModes);
        }
        private void ReceiveFanSwitchMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessFanSwitchMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iFanModeOne, iFanModeTwo);
        }
        private void ReceiveDehumidifierSetPointMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessDehumidifierSetPointMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iDehumidifySetPoint, iDehumidifyUpperLimit, iDehumidifyLowerLimit);
        ...
        private void ReceiveHumidifierSetPointMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessHumidifierSetPointMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iHumiditySetPoint, iHumidityUpperLimit, iHumidityLowerLimit);
        ...
        private void ReceiveScheduleMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessScheduleMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iScheduleDay, iSchedulePeriod, iScheduleTime, iHeatSetPoint, iCoolSetPoint, iFanMode);
        }
        ...
        private void ReceiveRoomTempMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessRoomTempMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iRoomTemperature, bRoomSensorFault, bRoomDegreeCelsius);
        }
        ...
        private void ReceiveRoomHumidityMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessRoomHumidityMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iRoomHumidity);
        }
        ...
        private void ReceiveAirFilterTimerMessage(string[] sList, Message strMsg)
        {
            ...
            m_objApp.ProcessAirFilterMessage(m_objHvacUnit.UnitNumber, iZoneNumber, iRemainingFilterTime, iTotalFilterTime);
        }
        #endregion

        #region "  Private Format Message Methods   "

        #region "  Private Format Change Message Methods   "
        ...
        #region "  Private Format Query Message Methods   "
        ...
        public string FormatQueryAllSchedulesMessage()
        {
            string szMessage = "M 1F80 00 Q 01 00";
            szMessage += " " + CalculateCheckSum(szMessage);
        ...
        private void SeenZoneInstance(int iZoneNumber)
        {
            clsEnviracomApp.TraceEvent(TraceEventType.Verbose, "clsMessageMgr::SeenZoneInstance: saw zone instance id: '" + iZoneNumber + "' on unit: '" + m_objHvacUnit.UnitNumber + "'");
            m_objApp.SeenZoneInstance(m_objHvacUnit.UnitNumber, iZoneNumber);
        }
